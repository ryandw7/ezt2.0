...
export const getNewCoreServicesTotalCost = createSelector([getNewCoreServices], (newCoreServices) => {
...
const useNewCoreSelectors = () => {
    ...
    const memoizedNewCoreServices = useMemo(() => getNewCoreServices(state), [state])
    ...
    return { newCore, newCoreServices, newInternet, newInternetCost, newTv, newTvCost, newCoreNotes, newCoreServicesTotalCost }
}
