...
const useCurrentActions = () => {
    ...
    return { updateCurrent, updateCurrentInternet, updateCurrentInternetCost, updateCurrentTv, updateCurrentTvCost, updateCurrentMobile, updateCurrentMobileCost, updateCurrentNotes }
}
