...
export default function MobileLineView({ line, lineCost, config, handleStartEdit }) {
    ...
    return (
            <Paper elevation={4} sx={{ display: "flex", flexDirection: "column", position: "relative", justifyContent: "space-around", alignContent: "center", minWidth:"300px", m:5, border: handleEditBorder()}}>
                {isForm && <Button onClick={handleStartEdit}sx={{ position: "absolute", top: '5px', left: "95%", p: 0, m: 0, height:"fit-content", width:"fit-content"}}><EditOutlinedIcon/></Button>}
                {isFull && <><RowGroup>
