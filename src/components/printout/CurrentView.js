...
const CurrentView = ({ currentServices }) => {
    ...
    return (
        <Paper elevation={3} sx={{ p: "0px", width: "100%", borderTopRightRadius: "20px", borderTopLeftRadius: "20px", backgroundColor: "#F5F5F5" }} className="current-view">
            ...
            <Box sx={{display: "flex", flexDirection:"column", alignItems: "space-around", justifyContent:"space-around",width:"100%"}}>
                <Box sx={{textAlign:"center", height:"max-content"}}>
                    <Typography variant="h3">Internet: {internetCost}</Typography>
